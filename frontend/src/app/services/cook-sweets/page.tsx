        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <div className="bg-white rounded-3xl overflow-hidden mb-12">
            <div className="w-full h-[400px] md:h-[500px] relative rounded-3xl overflow-hidden mb-10 shadow-sm">
              ...
              <img 
                src="https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?q=80&w=1200&auto=format&fit=crop" 
                alt="Sweets (Halwai) Cook" 
            ...
            <div className="space-y-6 text-slate-700 leading-relaxed">
              ...
              <p className="text-lg">
                Traditional Indian sweets (mithai) prepared with pure ingredients by expert halwais.
              </p>
              
              <p>
                A clean and well-maintained environment is essential for a healthy and comfortable lifestyle. Our <strong>Sweets (Halwai) Cook</strong> ensures every detail is taken care of. Over time, regular maintenance is required that routine cleaning cannot fully address. Our expert process covers every aspect to ensure thorough hygiene and long-lasting freshness.
              </p>
              ...
              <p>
                When you choose our <strong>Sweets (Halwai) Cook</strong>, you can expect spotless results, reliable service, and an overall refreshing environment. We take pride in providing reliable service with timely execution and excellent customer support.
              </p>
