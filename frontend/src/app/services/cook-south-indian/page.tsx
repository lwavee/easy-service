        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <div className="bg-white rounded-3xl overflow-hidden mb-12">
            ...
            <div className="space-y-6 text-slate-700 leading-relaxed">
              ...
              <p className="text-lg">
                Experience the rich flavors of South India with our specialized cooks. From crispy dosas to flavorful curries.
              </p>
              
              <p>
                A clean and well-maintained environment is essential for a healthy and comfortable lifestyle. Our <strong>South Indian Cook</strong> ensures every detail is taken care of. Over time, regular maintenance is required that routine cleaning cannot fully address. Our expert process covers every aspect to ensure thorough hygiene and long-lasting freshness.
              </p>
              ...
              <p>
                When you choose our <strong>South Indian Cook</strong>, you can expect spotless results, reliable service, and an overall refreshing environment. We take pride in providing reliable service with timely execution and excellent customer support.
              </p>
